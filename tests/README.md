...
* [CodeIgniter 4 User Guide on Testing](https://codeigniter.com/user_guide/testing/index.php)
...
The HTML files can be viewed by opening **tests/coverage/index.php** in your favorite browser.
