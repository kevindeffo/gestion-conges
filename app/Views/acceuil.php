      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.php" class="text-nowrap logo-img">
            <p> <button class="d"> <h2> <b>CONGE QC</b> </h2></button>  </p>
            <style>
              .d{
                height: 50px;
                width: 200px;
            ...
            <img src="../src/assets/images/logos/" alt=""  /> 
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/acceuil.php" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/Home/index" aria-expanded="false">
                ...
                <span class="hide-menu"> Mes demandes de congé</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./authentication-login.html" aria-expanded="false">
                ...
                <span class="hide-menu">changer de compte</span>
              </a>
            </li>
            <li class="sidebar-item">
          ...
          <div
            ...
            <div class="unlimited-access-img">
              <img src="../src/assets/images/backgrounds/rupee.png" alt="" class="img-fluid">
            </div>
          </div>
        </nav>
          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <a href="https://www.wrappixel.com/templates/materialm-free-bootstrap-admin/" target="_blank"
                class="btn btn-primary">Infos de compte</a>
                      ...
                      <div class="d-flex mb-10 pb-1 justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-6">
                          ...
                          <h6 class="mb-0 fs-4 fw-medium text-muted">
                            Statut de mes dernieres demandes
                          </h6>
                        </div>
            ...
            <div class="col-lg-8 d-flex align-items-stretch">
              <div class="card w-100 overflow-hidden">
                <div class="card-body pb-0">
                  <h4 class="fs-4 mb-1 card-title">Rapports des dernieres demandes de congés</h4>
                    ...
                    <table class="table text-nowrap mb-0 align-middle table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center product">
                              <img src="../src/assets/images/products/s1.jpg" class="img-fluid flex-shrink-0 rounded"
                                width="60" height="60" />
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center product">
                              <img src="../src/assets/images/products/s2.jpg" class="img-fluid flex-shrink-0 rounded"
                                width="60" height="60" />
                              <div class="ms-3 product-title">
                                <h6 class="fs-3 mb-0 text-truncate-2">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center product">
                              <img src="../src/assets/images/products/s3.jpg" class="img-fluid flex-shrink-0 rounded"
                                width="60" height="60" />
                              <div class="ms-3 product-title">
                                <h6 class="fs-3 mb-0 text-truncate-2">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center product">
                              <img src="../src/assets/images/products/s5.jpg" class="img-fluid flex-shrink-0 rounded"
                                width="60" height="60" />
                              <div class="ms-3 product-title">
                                <h6 class="fs-3 mb-0 text-truncate-2">
              ...
              <div class="card w-100">
                <div class="card-body">
                  <div class="d-flex mb-3 justify-content-between align-items-center">
                    <h4 class="mb-0 card-title">jours de congés bloquées</h4>
                    <div class="dropdown">
          ...
          <div class="row">
              ...
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../src/assets/images/blog/blog-img1.jpg" class="card-img-top" alt="materialM-img">
                  </a>
                  <span
                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                  <img src="../src/assets/images/profile/user-3.jpg" alt="materialM-img"
            ...
            <div class="col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../src/assets/images/blog/blog-img2.jpg" class="card-img-top" alt="materialM-img">
                  </a>
                  <span
                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                  <img src="../src/assets/images/profile/user-2.jpg" alt="materialM-img"
                    class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40"
                    height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
                </div>
                <div class="card-body p-4">
            ...
            <div class="col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../src/assets/images/blog/blog-img3.jpg" class="card-img-top" alt="materialM-img">
                  </a>
                  <span
                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
